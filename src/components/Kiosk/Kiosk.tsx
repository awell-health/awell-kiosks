...
import {
  Home,
  Identification,
  PathwayOrchestration,
  PathwaySelection,
} from './Stages'

export const Kiosk = () => {
  const { currentStage } = useContext(KioskContext)
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {currentStage === 'WELCOME' && <Home />}
      {currentStage === 'IDENTIFICATION' && <Identification />}
      {currentStage === 'PATHWAY_SELECTION' && <PathwaySelection />}
      {currentStage === 'PATHWAY_ORCHESTRATION' && <PathwayOrchestration />}
    </div>
  )
}
